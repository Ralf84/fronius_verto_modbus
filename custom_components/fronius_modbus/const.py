...
INVERTER_SENSOR_TYPES = {
    ...
    'mppt1_voltage': ['MPPT1 Voltage', 'mppt1_voltage', 'voltage', 'measurement', 'V', 'mdi:sine-wave', None],
    'mppt2_voltage': ['MPPT2 Voltage', 'mppt2_voltage', 'voltage', 'measurement', 'V', 'mdi:sine-wave', None],
    'mppt3_voltage': ['MPPT3 Voltage', 'mppt3_voltage', 'voltage', 'measurement', 'V', 'mdi:sine-wave', None],
